			...
			<div className="container mx-auto px-4">
				...
				<div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
					...
					<div className="relative">
						<video
							ref={videoRef}
							src="/2021_NV_final_caps.mp4"
							className="w-full h-64 lg:h-[32rem] object-cover rounded-2xl"
							autoPlay
							loop
							muted={isMuted}
							playsInline
						...
						<button
							...
							className="absolute top-4 right-4 z-10 bg-white/80 hover:bg-white text-primary rounded-full p-2 shadow-lg transition"
